...
- [Tools and Skills](./skills.md) — the tool-vs-skill model, writing a SKILL.md, adding a built-in tool.
- [HTTP API](./api.md) — enabling it, the endpoints, and triggering tasks from other systems.
